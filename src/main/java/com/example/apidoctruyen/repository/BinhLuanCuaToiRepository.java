...
public interface BinhLuanCuaToiRepository extends JpaRepository<Taikhoan, Integer> {
    ...
    public List<BinhLuanCuaToi> findByEmail(@Param("idtaikhoan") Integer idtaikhoan);
}
